...
public class DrawingView extends View {
    ...
    //se setea un area de dibujado para que haya interaccion
    ...
    //deteccion de movimiento del usuario
    @Override
    ...
    public void setPattern(String newPattern) {
        ...
        int patternID = getResources().getIdentifier(newPattern, "drawable", "com.example.proyecto_individual_apps");
    ...
    //se actualiza el tamaño de la brocha
    ...
    //se limpia el canvas para empezar otro nuevo
